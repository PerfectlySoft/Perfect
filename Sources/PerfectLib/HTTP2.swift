...
class HTTP2WebRequest: WebRequest {

}

class HTTP2WebResponse: WebResponse, HeaderListener {
...
//					}
	...
	func createRequest() -> HTTP2WebRequest {
...
//										}
	...
	func sendRequest(_ request: WebRequest, callback: (WebResponse?, String?) -> ()) {
